...
void main() {
  ...
  test("mn (Traditional) localization relative time test", () {
    ...
    expect(aMinuteAgo.from(now, dropPrefixOrSuffix: true), "1 ᠮᠢᠨᠦ᠋ᠲ᠋");
    expect(fiveMinutesAhead.from(now), "5 ᠮᠢᠨᠦ᠋ᠲ᠋ ᠦᠨ ᠳᠠᠷᠠᠭ᠎ᠠ");
    expect(fiveMinutesAgo.from(now), "5 ᠮᠢᠨᠦ᠋ᠲ᠋ ᠦᠨ ᠡᠮᠦᠨ᠎ᠡ");
    expect(fiveMinutesAgo.from(now, dropPrefixOrSuffix: true), "5 ᠮᠢᠨᠦ᠋ᠲ᠋");
  ...
  test("mn (Traditional with numbers) localization relative time test", () {
    ...
    expect(aMinuteAgo.from(now, dropPrefixOrSuffix: true), "᠑ ᠮᠢᠨᠦ᠋ᠲ᠋");
    expect(fiveMinutesAhead.from(now), "᠕ ᠮᠢᠨᠦ᠋ᠲ᠋ ᠦᠨ ᠳᠠᠷᠠᠭ᠎ᠠ");
    expect(fiveMinutesAgo.from(now), "᠕ ᠮᠢᠨᠦ᠋ᠲ᠋ ᠦᠨ ᠡᠮᠦᠨ᠎ᠡ");
    expect(fiveMinutesAgo.from(now, dropPrefixOrSuffix: true), "᠕ ᠮᠢᠨᠦ᠋ᠲ᠋");
